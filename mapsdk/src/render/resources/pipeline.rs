...
use crate::render::{
    create_image_texture_bgl, resources::bind_group::create_map_view_bgl, RenderingContext,
};
...
pub fn create_image_pipeline(rendering_context: &RenderingContext) -> RenderPipeline {
    ...
    let pipeline_layout = device.create_pipeline_layout(&PipelineLayoutDescriptor {
        ...
        bind_group_layouts: &[&map_view_bind_group_layout, &texture_bind_group_layout],
